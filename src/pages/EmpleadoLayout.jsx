...
import {
  ...
  ChevronDown, LogOut, User, Circle, Settings, Bell, GraduationCap, X
} from 'lucide-react'
...
export default function EmpleadoLayout() {
  ...
  if (location.pathname === '/empleado')
    navigate('/empleado/chat', { replace: true })
  ...
  return (
    <TemaContext.Provider value={{ dark, setDark, tk }}>
      <div style={{
